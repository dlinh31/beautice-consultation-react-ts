...
const Container = styled.div`
    ${tw`flex flex-col justify-center items-center text-center max-w-full p-0 mb-[5.35rem]
    md:(p-[2rem])
    sm:(p-[1rem])
    `}
`
...
const Services = () => {
  return (
    <Container>
            ...
            <Text>Porta rhoncus orci condimentum vitae lobortis eu dignissim non massa. 
                Non parturient amet, feugiat tellus sagittis, scelerisque eget nulla turpis.</Text>
    </Container>
  )
}
